...
makeBarPlot <- function(summaryData, organSystem) {
  ...
  #saveRDS(Data2,"Data2.RDS")
   b <- ggplot(Data2, aes( x = Indicators, y = Values, fill = Species ))
   barplot<-b + geom_bar( position = "dodge", stat = "identity", alpha = .5 )
